...
**Pros**
- âœ“ Exceptionally compact and lightweight for a 67W charger.
- âœ“ Three ports (2x USB-C & 1x USB-A) allow simultaneous charging of multiple devices.
- âœ“ Advanced safety features like ActiveShield™ temperature control offer peace of mind.

**Cons**
- âœ— Price is slightly higher than some basic 65W GaN chargers.
- âœ— Doesn't include a cable – you’ll need to provide your own USB-C to USB-C or USB-A cables.
...
**Pros**
- âœ“ Exceptionally compact and lightweight design - perfect for travel.
- âœ“ Fast charging capabilities with Power Delivery (PD) and Quick Charge (QC).
- âœ“ UK plug built-in – no adapter needed!

**Cons**
- âœ— Only two USB-C ports, lacking traditional USB-A connectivity.
- âœ— 65W shared between both ports, so full power isn't available when charging two devices at once.
...
**Pros**
- âœ“ Remarkably compact and lightweight - ideal for travel.
- âœ“ Fast charging speeds with Power Delivery (PD) and Programmable Power Supply (PPS).
- âœ“ Excellent build quality and reliable performance from a trusted brand. 

**Cons**
- âœ— Only features a single USB-C port, limiting simultaneous charging of multiple devices.
- âœ— Cable not included in the box – you’ll need to provide your own USB-C cable.
